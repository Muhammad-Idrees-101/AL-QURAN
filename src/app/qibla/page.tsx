    ...
    <>
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The Qibla is the direction of the Kaaba in Mecca, Saudi Arabia. Muslims around the world face this fixed direction during their daily prayers (Salah)."
                }
              },
              {
                "@type": "Question",
                "name": "How do I calibrate my phone's Qibla compass?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Keep your device flat and perfectly horizontal. Stay clear of metallic objects, magnets, and heavy electronics. If inaccurate, wave your phone in a large Figure 8 (∞) motion."
                }
              },
              {
                "@type": "Question",
                "name": "What are the exact coordinates of the Kaaba?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The Kaaba is located at 21° 25' 21\" N, 39° 49' 34\" E in Mecca, Saudi Arabia."
                }
              }
            ]
          })
      ...
      <div className="min-[1200px]:hidden min-h-screen px-4 md:px-8 pt-8 pb-20 max-w-3xl mx-auto">
        <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-3xl font-bold text-white mb-2">🕌 Qibla Direction & Prayer Times</h1>
          <p className="text-sm text-gray-400 mb-8">Find the direction of Mecca and today&apos;s prayer schedule</p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* Semantic H2 for SEO — Find Your Qibla Direction */}
          <h2 className="sr-only">Find Your Qibla Direction</h2>
          <QiblaCompass />
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 flex flex-col justify-between">
            <div>
              {/* How Qibla Direction is Calculated — H2 for SEO */}
              <h2 className="sr-only">How Qibla Direction is Calculated</h2>
        ...
        {/* Semantic H2 for SEO — Today's Prayer Times */}
        <h2 className="sr-only">Today&apos;s Prayer Times</h2>
        <PrayerTimesWidget />
      </div>
    </>
  );
